    ...
    <div id="guts">
        ...
        <div class="row">
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" href="#" data-toggle="modal" id="dlg" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_dlg.jpg" alt="Direct Line Group">
      				<div class="caption">Direct Line Group</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" href="#" data-toggle="modal" id="bostonIvy" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_bostonivy.jpg" alt="Boston Ivy">
      				<div class="caption">Boston Ivy</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" href="#" data-toggle="modal" id="treasure8" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_treasure8.jpg" alt="Treasure8">
      				<div class="caption">Treasure8</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" href="#" data-toggle="modal" id="cascades" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_thecascades.jpg" alt="The Cascades">
      				<div class="caption">The Cascades</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" href="#" data-toggle="modal" id="beforeTheTour" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_beforethetour.jpg" alt="Before the Tour">
      				<div class="caption">Before the Tour</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" href="#" data-toggle="modal" id="invenias" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_invenias.jpg" alt="Invenias">
      				<div class="caption">Invenias</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" href="#" data-toggle="modal" id="missionHousing" data-target=".modal_detail" class="thumbnail">
