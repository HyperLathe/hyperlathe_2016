    ...
    <div id="guts">
        ...
        <div class="row">
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a href="#" data-toggle="modal" data-target=".dlg_detail" class="thumbnail">
  			...
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a href="#" data-toggle="modal" data-target=".treasure8_detail" class="thumbnail">
      				<img src="./img/thumbnail_treasure8.jpg" alt="Treasure8">
      				<div class="caption">Treasure8</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a href="#" data-toggle="modal" data-target=".thecascades_detail" class="thumbnail">
      				<img src="./img/thumbnail_thecascades.jpg" alt="The Cascades">
      				<div class="caption">The Cascades</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a href="#" data-toggle="modal" data-target=".beforethetour_detail" class="thumbnail">
      				<img src="./img/thumbnail_beforethetour.jpg" alt="Before the Tour">
      				<div class="caption">Before the Tour</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a href="#" data-toggle="modal" data-target=".invenias_detail" class="thumbnail">
      				<img src="./img/thumbnail_invenias.jpg" alt="Invenias">
      				<div class="caption">Invenias</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a href="#" data-toggle="modal" data-target=".missionhousing_detail" class="thumbnail">
