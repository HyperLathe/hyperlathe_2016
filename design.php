...
<section id="main-content" class="container-fluid">
    <div id="guts">
        ...
        <div class="row">
  			...
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a href="#" data-toggle="modal" data-target=".ashleyspub_detail" class="thumbnail">
