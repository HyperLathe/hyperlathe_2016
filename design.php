...
<section id="main-content" class="container-fluid">
    <div id="guts">
        ...
        <div class="row">
  			...
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" data-toggle="modal" id="pcs" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_pcs.jpg" alt="Payment Card Solutions screenshot">
      				<div class="caption">Payment Card Solutions</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" data-toggle="modal" id="burningMan" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_burningman.jpg" alt="Burning Man detail map">
      				<div class="caption">Burning Man</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" data-toggle="modal" id="annSummers" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_annsummers.jpg" alt="Ann Summers screenshot">
      				<div class="caption">Ann Summers</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" data-toggle="modal" id="ima" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_ima.jpg" alt="Iron Monkey Arts logo">
      				<div class="caption">Iron Monkey Arts</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" data-toggle="modal" id="inw" data-target=".modal_detail" class="thumbnail">
      				<img src="./img/thumbnail_ignitionnw.jpg" alt="Ignition Northwest book cover">
      				<div class="caption">Ignition Northwest</div>
    			</a>
  			</div>
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" data-toggle="modal" id="myStyleSearch" data-target=".modal_detail" class="thumbnail">
  			...
  			<div class="col-xs-12 col-sm-6 col-md-4	">
    			<a onclick="loadModal(this.id)" data-toggle="modal" id="ashleysPub" data-target=".modal_detail" class="thumbnail">
